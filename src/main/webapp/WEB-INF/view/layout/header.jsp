...
<body>
	<div class="jumbotron text-center banner--img" style="margin-bottom: 0">
		...
		<img alt="smaple" src="https://picsum.photos/300/200">
	</div>
	...
	<div class="container" style="margin-top: 30px">
		<div class="row">
			<div class="col-sm-4">
				...
				<p style="padding: 8px 0">자라나는 코린이의 은행 관리 시스템 입니다.</p>
				<h3>Some Links</h3>
				<p>Lorem ipsum dolor sit ame.</p>
				<ul class="nav nav-pills flex-column">
					<li class="nav-item"><a class="nav-link active" href="/account/save">계좌 생성</a>
					</li>
